...
<body>
  ...
  <script>
const lodges = [
  {id:'us-1',country:'USA',city:'Aspen, Colorado',name:'Silver Pine Lodge',rating:4.8,offer:2350,img:'https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?auto=format&fit=crop&w=900&q=80',desc:'A fictional alpine retreat surrounded by mountain scenery, fireplaces and quiet winter charm.'},
  {id:'us-2',country:'USA',city:'Sedona, Arizona',name:'Red Rock Haven',rating:4.7,offer:1850,img:'https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&w=900&q=80',desc:'A classroom-demo desert hideaway inspired by dramatic red-rock landscapes and wellness escapes.'},
  {id:'us-3',country:'USA',city:'Jackson, Wyoming',name:'Grand Teton Hearth',rating:4.9,offer:2500,img:'https://images.unsplash.com/photo-1549294413-26f195200c16?auto=format&fit=crop&w=900&q=80',desc:'A fictional timber lodge concept with broad mountain views and warm, rustic interiors.'},
  {id:'us-4',country:'USA',city:'Lake Tahoe, California',name:'Tahoe Crest Retreat',rating:4.6,offer:1550,img:'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?auto=format&fit=crop&w=900&q=80',desc:'A made-up lakeside lodge for demonstrating filtering, payments and review submission.'},
  {id:'us-5',country:'USA',city:'Napa Valley, California',name:'Vineyard House Lodge',rating:4.8,offer:2100,img:'https://images.unsplash.com/photo-1568084680786-a84f91d1153c?auto=format&fit=crop&w=900&q=80',desc:'A fictional vineyard stay with garden courtyards and relaxed countryside styling.'},
  {id:'us-6',country:'USA',city:'Maui, Hawaii',name:'Pacific Palm Lodge',rating:4.7,offer:1950,img:'https://images.unsplash.com/photo-1561501900-3701fa6a0864?auto=format&fit=crop&w=900&q=80',desc:'A fictional tropical lodge profile used exclusively for this educational project.'},
  {id:'uae-1',country:'UAE',city:'Dubai',name:'Desert Pearl Retreat',rating:4.9,offer:2450,img:'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=900&q=80',desc:'A fictional luxury desert retreat concept combining modern design and dune-inspired scenery.'},
  {id:'uae-2',country:'UAE',city:'Abu Dhabi',name:'Oasis Crown Lodge',rating:4.7,offer:1750,img:'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=900&q=80',desc:'A made-up oasis lodge profile with shaded courtyards, pools and tranquil desert styling.'},
  {id:'uae-3',country:'UAE',city:'Ras Al Khaimah',name:'Jebel Vista Lodge',rating:4.8,offer:2250,img:'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=900&q=80',desc:'A fictional mountain retreat concept created for the school review-payment demonstration.'},
  {id:'uae-4',country:'UAE',city:'Dubai',name:'Creek Lantern House',rating:4.5,offer:1300,img:'https://images.unsplash.com/photo-1571896349842-33c89424de2d?auto=format&fit=crop&w=900&q=80',desc:'A fictional city lodge blending traditional-inspired details with a modern waterfront feel.'},
  {id:'uae-5',country:'UAE',city:'Sharjah',name:'Al Noor Garden Lodge',rating:4.6,offer:900,img:'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=900&q=80',desc:'A fictional garden-focused lodge created as a low-range reward example for the demo.'},
  {id:'uae-6',country:'UAE',city:'Fujairah',name:'Hajar Coast Lodge',rating:4.8,offer:2050,img:'https://images.unsplash.com/photo-1540541338287-41700207dee6?auto=format&fit=crop&w=900&q=80',desc:'A fictional east-coast escape inspired by mountains, sea views and relaxed resort design.'}
];
...
function updateNav(){const s=session();$('#authBtn').classList.toggle('hidden',!!s);$('#dashboardBtn').classList.toggle('hidden',!s);$('#joinBtn').textContent=s?'View dashboard':'Create account'}
...
window.viewLodge=function(id){activeLodge=lodges.find(l=>l.id===id);selectedStars=5;renderLodgeModal();openModal('lodgeModal')};
